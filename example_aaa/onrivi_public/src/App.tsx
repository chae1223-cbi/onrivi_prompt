    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center px-6">
      ...
      >
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-white/60">당신의 AI 경험을 자산으로 만드세요</p>
        </div>
        ...
        <p className="mt-8 text-center text-xs text-white/40">
          계속함으로써 온리비의 <a href="#" className="underline">서비스 약관</a> 및 <a href="#" className="underline">개인정보 처리방침</a>에 동의하게 됩니다.
        </p>
      </motion.div>
    </div>
  );
      ...
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        >
          ...
          <p className="max-w-2xl mx-auto text-lg md:text-xl text-white/60 mb-10 leading-relaxed">
            온리비(Onrivi)는 창작자들의 아이디어와 AI 대화 기록이 흩어지지 않고 
            가치 있는 데이터로 축적될 수 있도록 돕는 AI 자산 관리 솔루션입니다.
          </p>
          ...
          >
            <div>
              ...
              <p className="text-3xl md:text-4xl font-bold text-white leading-tight">
                파편화된 AI 대화 기록을 체계적인 지적 자산으로 전환하여 개인과 기업의 생산성을 극대화합니다.
              </p>
            </div>
            <div>
  ...
  const values = [
    {
      ...
      desc: "단순한 툴을 넘어, 사용하는 즐거움을 주는 세련된 UI와 사용자 경험을 지향합니다.",
      icon: <Zap className="w-6 h-6 text-emerald-400" />,
      tag: "프리미엄 경험"
    },
    {
      title: "Privacy & Security",
      desc: "사용자 격리 설계와 로컬 데이터 기반 설계를 통해 고객의 소중한 지적 자산 보안을 최우선으로 합니다.",
      icon: <Lock className="w-6 h-6 text-blue-400" />,
      tag: "철저한 보안"
    },
    {
      title: "Hybrid Innovation",
      desc: "로컬 파일 시스템의 강력함과 클라우드 SaaS의 유연성을 결합한 온리비만의 독보적인 아키텍처를 제공합니다.",
...
const Products = () => {
  const products = [
    {
      name: "Onrivi Prompt",
      desc: "폴더/파일 계층 구조의 탐색기와 동적 변수 시스템을 통해 AI 프롬프트를 체계적으로 저장, 분류, 실행할 수 있는 프리미엄 솔루션입니다.",
    ...
    },
    {
      ...
      desc: "전문적인 프롬프트 작성 및 관리 방법론을 제공하여 AI 활용 능력을 극대화합니다.",
    ...
    },
    {
      ...
      desc: "기업의 특수한 환경에 맞춘 기업 특화형 AI 연동 및 데이터 관리 솔루션을 지원합니다.",
        ...
        <div className="p-12 md:p-20 rounded-[3rem] bg-gradient-to-br from-zinc-900 to-black border border-white/5 relative overflow-hidden group">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-white/70 leading-relaxed mb-8">
              온리비(Onrivi)는 창작자들의 아이디어와 AI 대화 기록이 흩어지지 않고 가치 있는 데이터로 축적될 수 있도록 돕는 AI 자산 관리 솔루션 기업입니다.
            </p>
      ...
      <section className="py-24 bg-emerald-500 text-black text-center">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-4xl md:text-6xl font-bold mb-8 tracking-tight">
            당신의 아이디어를<br />체계적인 데이터로 관리하세요.
          </h2>
          <p className="text-xl font-medium mb-12 text-black/80">
            Onrivi는 당신의 AI 경험을 가장 우아하게 자산화해 드립니다.
          </p>
          <button 
