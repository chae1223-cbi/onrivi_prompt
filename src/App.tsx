      ...
      >
        ...
        <div className="text-center mb-10">
          <div className="w-48 h-48 mx-auto mb-10">
            <img src="/logo.png" alt={t('company')} className="w-full h-full object-contain rounded-[3rem] shadow-2xl shadow-emerald-500/40" />
          </div>
      ...
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        <div className="flex items-center gap-6 group cursor-pointer">
          <div className="relative">
            <img src="/logo.png" alt={t('company')} className="w-24 h-24 object-contain rounded-3xl transition-transform duration-500 group-hover:scale-110" />
            <div className="absolute inset-0 bg-emerald-500/30 blur-2xl opacity-0 group-hover:opacity-100 transition-opacity" />
          </div>
          <span className="text-4xl font-black tracking-tighter text-white uppercase">{t('company')}</span>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-6">
            <img src="/logo.png" alt={t('company')} className="w-20 h-20 object-contain rounded-2xl" />
            <span className="text-3xl font-black tracking-tighter text-white uppercase">{t('company')}</span>
          </div>
